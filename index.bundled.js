...
var require_tray = __commonJS({
  "src/tray.js"(exports, module) {
    var ICON_RELATIVE = ["assets", "icon.png"];
    var tray = null;
    function electron() {
      const electronRequire = eval("require");
      return electronRequire("electron");
    ...
    function showWindow(BrowserWindow) {
      try {
        ...
        const primary = services && typeof services.getPrimaryWindow === "function" ? services.getPrimaryWindow() : null;
      ...
      try {
        const windows = BrowserWindow && typeof BrowserWindow.getAllWindows === "function" ? BrowserWindow.getAllWindows() : [];
    ...
    function quitApp(app2, execFn) {
      ...
      try {
        if (app2 && typeof app2.exit === "function") app2.exit(0);
      } catch {
      }
      const kill = typeof execFn === "function" ? execFn : process.platform === "win32" ? (cmd) => nodeChildProcess().exec(cmd) : null;
      if (kill) {
        try {
    ...
    function startTray(api2, overrides) {
      destroyTray();
      const log = api2 && api2.log || { info() {
      }, warn() {
      } };
      ...
      let app2;
      try {
        ({ Tray, Menu, nativeImage, BrowserWindow, app: app2 } = e || electron());
      } catch {
      ...
      const clickQuit = () => quitApp(app2, overrides && overrides.exec);
      try {
...
var { startTray: startTray2, destroyTray: destroyTray2 } = require_tray();
module.exports = {
  start(api2) {
